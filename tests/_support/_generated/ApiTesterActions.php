<?php  //[STAMP] fbc9d76733839cfd907145a712700875
...
trait ApiTesterActions
{
     ...
     */
    public function canSeeResponseJsonArrayCountEqual($expression, $nb) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeResponseJsonArrayCountEqual', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function seeResponseJsonArrayCountEqual($expression, $nb) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeResponseJsonArrayCountEqual', func_get_args()));
    }
     ...
     * @see \Helper\Api::jsonPathFind()
     */
    public function jsonPathFind($expression) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('jsonPathFind', func_get_args()));
    }
}
